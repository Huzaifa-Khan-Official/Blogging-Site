        ...
        <div className="w-full bg-white rounded-2xl shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-6">
              ...
              />
              <p className="text-red-500 text-xs italic mt-2">{errors.username && errors.username.message}</p>
            </div>
            ...
            <div className="mb-6">
              ...
              />
              <p className="text-red-500 text-xs italic mt-2">{errors.email && errors.email.message}</p>
            </div>
